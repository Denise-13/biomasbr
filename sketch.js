...
function preload() {
  ...
  img1=loadImage('amazonias.png');
  img2=loadImage('tela4.png');
  img3=loadImage('caatingas.png');
  img4=loadImage('cerrados.png');
  img5=loadImage('mataatlanticas.png');
  img6=loadImage('pantanals.png');
  img7=loadImage('pampas.png');
